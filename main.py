...
#to set hebir kal with biggest counter number and tagger
  ...
  for L_counter in  merged:
   if merged[L_counter][0] == 'NV' and merged[L_counter][-1] > 1 and nn != True :
        ...
        hebir_kal = L_counter
        adv = True
   elif merged[L_counter][0] == 'AdjV' and merged[L_counter][-1] > 1 and nn != True and nv != True and adj != True and adv != True :
        hebir_kal = L_counter
        adjV = True
   elif merged[L_counter][0] == 'AdjN' and merged[L_counter][-1] > 1 and nn != True and nv != True and adj != True and adv != True and adjV != True:
       hebir_kal = L_counter
       adjN = True
   elif merged[L_counter][0] == 'AdvV' and merged[L_counter][-1] > 1 and nn != True and nv != True and adj != True and adv != True and adjV != True and adjN  != True:
       hebir_kal = L_counter
       advV = True
   elif merged[L_counter][0] == 'AdvN' and merged[L_counter][-1] > 1 and nn != True and nv != True and adj != True and adv != True and adjV != True and adjN != True and advV != True:
       hebir_kal = L_counter
       advN = True
   elif merged[L_counter][0] == 'AdvAdj' and merged[L_counter][-1] > 1 and nn != True and nv != True and adj != True and adv != True and adjV != True and adjN != True and advV != True and advN != True:
       hebir_kal = L_counter
...
if __name__ == '__main__':
   text_preprocessing("ያቶ ሰይፉ ባሕርይ እጅግ ያስቸግራል፣ ጠላቱን እጅ ነሥቶ ለወዳጁ ይኮራል።")
